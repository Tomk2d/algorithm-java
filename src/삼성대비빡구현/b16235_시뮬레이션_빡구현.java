...
*
*       아 그리고, 반복문 돌면서 List 를 꺼내서 검사하고, 추가/삭제하는 작업이 있을 수 있다.
*       이 경우는 해당 반복문에서 작업을 수행하지 않고,
*       추가 및 삭제할 값을 새로운 list 에 넣어두었다가, 추후에 반영하는 식으로 한다.
*       대신 단순한 값을 변경하는 작업은 list.set(i, newValue); 와 같이
*       set 을 사용해서 활용 가능하다.
* */
